...
After a provider-defined suite has been selected or installed,
SSL_set_SSL_CTX() rejects a target context that lacks an equivalent suite or
whose security callback rejects it.
