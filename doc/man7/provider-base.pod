...
A printable ASCII name of 1 to 255 bytes without a colon. It must be unique,
ignoring case, among built-in and provider-defined ciphersuites.
...
with a built-in or previously discovered ciphersuite.
...
cacheable or serialisable and do not produce session tickets.
